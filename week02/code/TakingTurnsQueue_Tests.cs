...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue() was adding to the back of the queue, not the front. 
    ...
    // Defect(s) Found: None?  Fixed with last error?
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim is not being enqueued after going once because his Turn amount is less than 1.
    ...
    // Defect(s) Found: Tim was still being taken out of the queue because of how we fixed the previous problem 
    ...
    // Defect(s) Found: None? Error was thrown as expected?
